...
<SCRIPT language=javascript>
	function to_page(page) {
		...
		// document对象调用from表单的name属性调用submit()
		document.customerForm.submit();
	}
	
	// 加载页面时发送AJax请求动态显示客户级别和客户来源
	$(function(){
		var url = "${pageContext.request.contextPath}/dict_findByCode.action";
		//用 002 去查询客户信息来源(电话营销或者网络营销)
		var param = {"dict_type_code":"002"};
		$.post(url,param,function(data){
			// 响应的data对象是一串json格式的字符串
			// each 遍历 function() 没参数 this.属性
			// each 如果有参数 function（i，n） i代表索引，代表对象
			$(data).each(function(i,n){
				// model 是customer对象
				var cid = "${model.source.dict_id}";
				if(n.dict_id == cid){
	...
	$(function(){
		var url2 = "${pageContext.request.contextPath}/dict_findByCode.action";
		//用 002 去查询客户信息来源(电话营销或者网络营销)
		var param2 = {"dict_type_code":"006"};
